...
(function() {
  var ImageResizer, argv, easyimg, fs, fsu, happens, path, _,
  ...
  module.exports = ImageResizer = (function() {
    ...
    ImageResizer.prototype.next_tick = function() {
      var image,
        _this = this;
      if (this.counter < this.raw.length - 1) {
        ...
        return easyimg.info(image).then(function(file) {
          ...
          return _this.resize_img(image, w, h, function() {
            console.log("resized.");
            return _this.crop_image(image, w, h, function() {
              console.log("cropped.");
              return _this.next_tick();
            });
          });
        }, function(err) {
    ...
    ImageResizer.prototype.check_filename = function(test) {
      if (test.indexOf("/") !== -1) {
